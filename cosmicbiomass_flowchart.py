...
def create_cosmicbiomass_flowchart():
    ...
    # Title
    ax.text(
        5, 24, "CosmicBiomass Workflow", fontsize=20, fontweight="bold", ha="center"
    )
    ax.text(
        5,
        23.5,
        "Satellite Biomass Extraction with Footprint Weighting",
        fontsize=14,
        ha="center",
        style="italic",
    )
    ...
    def create_box(x, y, width, height, text, color, text_size=9):
        ...
        ax.text(
            ...
            fontsize=text_size,
            wrap=True,
            fontweight="bold" if "START" in text or "END" in text else "normal",
        )
    ...
    create_box(
        ...
        2,
        0.8,
        'Use uncertainty band\nsource: "uncertainty_band"',
        colors["output"],
    )
    create_box(
        8.5, 6, 2, 0.8, 'Use data spread (std)\nsource: "data_spread"', colors["output"]
    )
    ...
    ax.text(
        5,
        3.5,
        "CosmicBiomass Architecture Notes",
        fontsize=12,
        fontweight="bold",
        ha="center",
    )
...
if __name__ == "__main__":
    ...
    plt.savefig(
        "/home/trinkle/Documents/thesis/cosmicbiomass/cosmicbiomass_workflow_flowchart.png",
        dpi=300,
        bbox_inches="tight",
        facecolor="white",
    )
    ...
    plt.savefig(
        "/home/trinkle/Documents/thesis/cosmicbiomass/cosmicbiomass_workflow_flowchart.pdf",
        bbox_inches="tight",
        facecolor="white",
    )
