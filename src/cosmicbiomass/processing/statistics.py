...
class StatisticsProcessor:
    ...
    def __init__(self, mask_invalid: bool = True, outlier_method: Optional[str] = None):
        """
    ...
    def _compute_uncertainty_statistics(
        ...
        try:
            ...
            weights_norm = weights_masked / np.sum(weights_masked)
            ...
            logger.warning(f"Failed to compute uncertainty statistics: {e}")
            return None
