...
from cosmicbiomass.processing.footprint import FootprintProcessor, validate_footprint_coverage
from cosmicbiomass.processing.statistics import StatisticsProcessor, BiomassStatistics
